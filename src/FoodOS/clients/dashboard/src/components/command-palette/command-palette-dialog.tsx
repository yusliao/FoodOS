    ...
    const allGroups: ActionGroup[] = [
      {
        ...
        items: [
          ...
          },
          {
            id: "nav-shop-catalog",
            label: "Order catalog",
            hint: "Quote prices for the selected store",
            Icon: ShoppingCart,
            keywords: ["shop", "order", "catalog", "price", "quote"],
            perform: go("/shop/catalog"),
            perm: "Permissions.Ordering.Shop.View",
          },
          {
            id: "nav-shop-cart",
            label: "Cart",
            hint: "Review quoted lines and place an order",
            Icon: ShoppingCart,
            keywords: ["shop", "cart", "checkout"],
            perform: go("/shop/cart"),
            perm: "Permissions.Ordering.Shop.Order",
          },
          {
            id: "nav-shop-orders",
            label: "Orders",
            hint: "Amend or cancel before cutoff",
            Icon: ClipboardList,
            keywords: ["shop", "orders", "amend", "cancel", "cutoff"],
            perform: go("/shop/orders"),
            perm: "Permissions.Ordering.Shop.View",
          },
          {
          ...
          },
          {
            ...
            Icon: ClipboardCheck,
            keywords: ["qc", "quality", "procurement", "inspection"],
            perform: go("/ops/qc"),
          ...
          },
          {
            id: "nav-ops-putaway",
            label: "Putaway",
            hint: "Confirm lots onto storage bins",
            Icon: Forklift,
            keywords: ["putaway", "storing", "warehouse", "bin"],
            perform: go("/ops/putaway"),
            perm: "Permissions.Warehouse.Putaway.View",
          },
          {
            id: "nav-ops-waves",
            label: "Waves",
            hint: "Cutoff, generate, release, pack",
            Icon: Layers,
            keywords: ["wave", "cutoff", "fefo", "pack", "tote"],
            perform: go("/ops/waves"),
            perm: "Permissions.Warehouse.Waves.View",
          },
          {
            id: "nav-ops-picks",
            label: "Pick tasks",
            hint: "Scan allocated lots on PDA",
            Icon: ScanLine,
            keywords: ["pick", "pda", "scan", "lot"],
            perform: go("/ops/picks"),
            perm: "Permissions.Warehouse.Picks.View",
          },
          {
            id: "nav-ops-shipments",
            label: "Load & POD",
            hint: "Scan totes, depart, sign delivery",
            Icon: Truck,
            keywords: ["shipment", "load", "pod", "delivery", "driver"],
            perform: go("/ops/shipments"),
            perm: "Permissions.Logistics.Shipments.View",
          },
          {
            id: "nav-products",
            label: "Products",
