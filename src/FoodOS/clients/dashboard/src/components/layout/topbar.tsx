 ...
 *  abbreviations like "Dr." so "Dr. FoodOS" → "MM" not "DM". */
    ...
    >
      ...
      <DropdownMenu modal={false}>
        <DropdownMenuTrigger asChild>
          <button
            type="button"
            aria-label={t("chrome.openProfile")}
            className={cn(
        ...
        >
          ...
          <div className="px-1 pb-1">
            <SimpleMenuItem icon={UserRound} label={t("chrome.profile")} onSelect={() => navigate("/settings/profile")} />
            <SimpleMenuItem icon={SettingsIcon} label={t("chrome.settings")} onSelect={() => navigate("/settings")} />
            <SimpleMenuItem icon={KeyRound} label={t("chrome.apiKeys")} onSelect={() => navigate("/settings/api-keys")} />
          </div>
          ...
          <div className="px-1 py-1">
            ...
            >
              ...
              <span className="text-[12.5px] font-medium">{t("chrome.signOut")}</span>
            </DropdownMenuItem>
          </div>
        </DropdownMenuContent>
      </DropdownMenu>
