    ...
    >
      {malformed ? (
        <div className="space-y-4">
          <div className="mb-2">
            <AuthHeadline lead={t("auth.linkIncompleteLead")} accent={t("auth.linkIncompleteAccent")} />
        ...
        <>
          <div className="mb-6 sm:mb-8">
            <AuthHeadline lead={t("auth.setPasswordLead")} accent={t("auth.setPasswordAccent")} />
            <p className="text-[13px] text-[var(--color-muted-foreground)]">
              {t("auth.resettingForLead")}{" "}
              <span className="text-[var(--color-foreground)]">{email}</span> {t("auth.resettingForOn")}{" "}
