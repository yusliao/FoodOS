  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5 fsh-enter">
      ...
      <SettingsSection
        ...
        icon={Camera}
        description={t("settings.photoDesc")}
      >
        <ImageInput
      ...
      >
        <div className="grid gap-5 sm:grid-cols-2">
          <Field id="first-name" label={t("settings.firstName")}>
            <Input
              id="first-name"
              value={firstName}
          ...
          <Field id="last-name" label={t("settings.lastName")}>
            <Input
              id="last-name"
              value={lastName}
      ...
      <SettingsSection
        title={t("settings.subjectId")}
        icon={Fingerprint}
        description={t("settings.subjectIdDesc")}
      >
