...
const TABS: Tab[] = [
  {
    ...
    hintKey: "settings.tabProfileHint",
    icon: UserRound,
  },
  {
    to: "/settings/security",
    labelKey: "settings.tabSecurity",
    hintKey: "settings.tabSecurityHint",
    icon: ShieldCheck,
  },
  {
    to: "/settings/sessions",
    labelKey: "settings.tabSessions",
    hintKey: "settings.tabSessionsHint",
    icon: MonitorSmartphone,
  },
  {
    to: "/settings/appearance",
    labelKey: "settings.tabAppearance",
    hintKey: "settings.tabAppearanceHint",
    icon: Palette,
  },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[260px_1fr] lg:gap-10">
        {/* ─── Editorial left nav ─── */}
        <nav aria-label={t("settings.sectionsAria")}>
