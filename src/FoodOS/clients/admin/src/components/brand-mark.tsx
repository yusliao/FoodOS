 ...
 * the brand initial, paired with the 东方味力 wordmark and an Admin sub-label.
 *
...
/**
 * BrandMarkXL — splash version for the Login page. Leads with the 东方味力
 * mark and wordmark, then a display monogram and a one-line
 * system blurb.
 */
