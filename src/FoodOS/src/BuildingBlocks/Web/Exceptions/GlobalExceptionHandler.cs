...
public class GlobalExceptionHandler(ILogger<GlobalExceptionHandler> logger) : IExceptionHandler
{
    public async ValueTask<bool> TryHandleAsync(HttpContext httpContext, Exception exception, CancellationToken cancellationToken)
    {
        ...
        if (exception is FluentValidation.ValidationException fluentException)
        {
            ...
            problemDetails.Title = SharedErrorText.Get(SharedErrorText.ValidationTitle, uiCulture);
            problemDetails.Detail = SharedErrorText.Get(SharedErrorText.ValidationDetail, uiCulture);
        ...
        else if (exception is UnauthorizedAccessException)
        {
            ...
            problemDetails.Status = statusCode;
            problemDetails.Title = SharedErrorText.Get(SharedErrorText.Unauthorized, uiCulture);
        ...
        else if (exception is KeyNotFoundException)
        {
            ...
            problemDetails.Status = statusCode;
            problemDetails.Title = SharedErrorText.Get(SharedErrorText.NotFound, uiCulture);
            problemDetails.Detail = exception.Message;
        }
        else if (exception is BadHttpRequestException badRequest)
        {
            ...
            problemDetails.Status = statusCode;
            problemDetails.Title = SharedErrorText.Get(SharedErrorText.BadRequest, uiCulture);
        ...
        else
        {
            ...
            problemDetails.Status = statusCode;
            problemDetails.Title = SharedErrorText.Get(SharedErrorText.UnexpectedTitle, uiCulture);
            problemDetails.Detail = SharedErrorText.Get(SharedErrorText.UnexpectedDetail, uiCulture);
        }
