...
namespace FoodOS.Migrations.PostgreSQL.Tickets
{
    ...
    [Migration("20260924011616_AddTicketOptimisticConcurrency")]
    partial class AddTicketOptimisticConcurrency
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FSH.Modules.Tickets.Domain.Ticket", b =>
                {
                    ...
                    b.HasIndex("CustomerTenantId", "ReporterUserId");

                    b.HasIndex("Number", "CustomerTenantId")
                        .IsUnique()
