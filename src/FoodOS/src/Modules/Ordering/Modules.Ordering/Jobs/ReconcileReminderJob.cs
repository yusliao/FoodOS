    ...
    ILogger<ReconcileReminderJob> logger)
{
    public async Task RunAsync(CancellationToken cancellationToken)
    {
        ...
        {
            logger.LogWarning("[Ordering] reconcile reminder skipped because the operator tenant is unavailable");
            return;
        }
        ...
        {
            logger.LogError(ex, "[Ordering] reconcile reminder failed for the operator tenant");
            return;
        }
