...
public sealed class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        builder.Property(x => x.TemperatureZone).HasConversion<string>().HasMaxLength(16).IsRequired();
        builder.Property(x => x.BaseUom).IsRequired().HasMaxLength(16);
        builder.Property(x => x.Barcode).HasMaxLength(64);
        builder.Property(x => x.StorageNote).HasMaxLength(512);
