...
```bash
dotnet build src/FoodOS.slnx
dotnet run --project src/Host/FoodOS.AppHost   # full Aspire stack
dotnet test src/FoodOS.slnx                    # tests (integration suite needs Docker)
```
